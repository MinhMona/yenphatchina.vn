                    ...
                    <div class="col s12">
                        <div class="row pb-2 border-bottom-1 ">
                            ...
                            <div class="input-field col s12 m6">
                                <asp:TextBox runat="server" placeholder="" ID="pWallet" TextMode="Number" class="validate" ReadOnly="true"></asp:TextBox>
                                <label for="rp_vnd">Số tiền nạp (VNĐ)</label>
                            </div>
                            <div class="input-field col s12">
                                <asp:TextBox runat="server" placeholder="" ID="pContent" ReadOnly="true"
