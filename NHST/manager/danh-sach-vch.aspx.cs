    ...
    public partial class danh_sach_vch : System.Web.UI.Page
    {
        ...
        private void LoadData()
        {
            ...
            if (ac != null)
            {
                ...
                var os = TransportationOrderNewController.GetAllWithFilter_SqlHelper(search, st, fd, td);
                if (os.Count > 0)
                {
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("danh-sach-vch?s=" + searchname + "&fd=" + fd + "&td=" + td + "&st=" + st );

            //if (!string.IsNullOrEmpty(searchname))/*(fd == "" && td == "" && st == -1)*/
            //{
            //    Response.Redirect("danh-sach-vch?s=" + searchname + "&fd=" + fd + "&td=" + td + "");
            //}
            //else
            //{
