        ...
        public void loaddata()
        {
            ...
            if (id > 0)
            {
                ...
                if (t != null)
                {
                    ...
                    //if (!string.IsNullOrEmpty(t.MaDonHang))
                    //{
                    //    MainOrderCode = t.MaDonHang;
                    //}    
                        ...
                        if (t != null)
                        {
                            ...
                            {                               
                                if (smallpacs.Count > 0)
                                {
                                    ...
                                    {
                                        SmallPackageController.UpdateStatus(item.ID, 0, currentDate, username_current);
                                    }
                                    double deposited = Math.Round(Convert.ToDouble(t.Deposited), 0);
                                    if (deposited > 0)
                                    {
                            ...
                            else if (status == 1)
                            {
                                if (smallpacs.Count > 0)
                                {
                                    foreach (var item in smallpacs)
                                    {
                                        SmallPackageController.UpdateStatus(item.ID, 1, currentDate, username_current);
                                    }
                                }
                            }
                            else if (status == 4)
                            ...
                            double totalWeightPrice = Convert.ToDouble(t.FeeWeight);
                            ...
                            double totalprice = totalWeightPrice + checkProductPrice + packagePrice + insurrancePrice + codtqVND;
