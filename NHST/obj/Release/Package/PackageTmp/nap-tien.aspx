                                                ...
                                                <div class="col s12">
                                                    ...
                                                    <div class="donate-guide">
                                                        ...
                                                        <strong>thanh toán</strong> một khoản tiền <strong>đặt
                                                            cọc trước cho Yến Phát China </strong>để chúng tôi thực hiện
                                                        ...
                                                        website đặt hàng Trung Quốc, số tiền này <strong>Yến Phát China thu hộ </strong>cho nhà cung cấp.
                                                        </p>
                                                        <p class="pl-3">
                                                            + <strong>Phí dịch vụ</strong>: là phí khách hàng
                                                        trả cho <strong>Yến Phát China </strong>để tiến hành thu mua theo đơn hàng đã đặt.
                                                        </p>
                                                        <h6 class="font-weight-700">CÓ 2 HÌNH THỨC THANH TOÁN:</h6>
                                                        <p class="pl-1">1. Thanh toán trực tiếp.</p>
                                                       <%-- <p class="pl-2">
                                                            - 2.Khách hàng có thể đặt cọc trực tiếp tại địa chỉ: K27, Nguyễn Phú Hường, Hòa Thọ Tây, Cẩm Lệ, Đà Nẵng
                                                        </p>--%>
                                                        <p class="pl-3">
                                                            + <strong>Văn phòng tại Đà Nẵng: K27, Nguyễn Phú Hường, Hòa Thọ Tây, Cẩm Lệ, Đà Nẵng</strong>
                                                        </p>
