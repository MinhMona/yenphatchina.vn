        ...
        public void loadData()
        {
            try
            {
                ...
                if (pt != null)
                {
                    ...
                    ltrTitle.Text = "<h1 class=\"main-title main-title-2\">" + pagetypename + "</h1>";
                    ...
                    string weblink = "https://yenphatchina.vn";
                    ...
                    if (!string.IsNullOrEmpty(pt.ogimage))
                        ...
                        objMetaFacebook.Content = weblink + "/App_Themes/DPG/images/logo.png";
